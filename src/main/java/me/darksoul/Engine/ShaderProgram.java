...
import me.darksoul.Engine.Maths.*;
...
public abstract class ShaderProgram {
    ...
    protected void loadUniform(int location, Vector3f vector) {
        GL20.glUniform3f(location, vector.x, vector.y, vector.z);
    }

    protected void loadUniform(int location, Vector4f vector) {
    ...
    protected void loadUniform(int location, Matrix4f matrix) {
        matrix.get(matrixBuffer);
        matrixBuffer.flip();
        GL20.glUniformMatrix4fv(location, false, matrixBuffer);
    }

    protected void loadUniform(int location, Matrix2f matrix) {
        matrix.get(matrixBuffer);
        matrixBuffer.flip();
        GL20.glUniformMatrix2fv(location, false, matrixBuffer);
    }

    protected void loadUniform(int location, Matrix3f matrix) {
        matrix.get(matrixBuffer);
        matrixBuffer.flip();
